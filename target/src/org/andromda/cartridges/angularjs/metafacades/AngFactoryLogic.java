...
/**
 * 
 * MetafacadeLogic for AngFactory
 *
 * @see AngFactory
 */
public abstract class AngFactoryLogic
    extends MetafacadeBase
    implements AngFactory
{
    /**
     ...
     * @param context
     */
    protected AngFactoryLogic(Object metaObjectIn, String context)
    {
     ...
     * The logger instance.
     */
    private static final Logger logger = Logger.getLogger(AngFactoryLogic.class);

    /**
     * Gets the context for this metafacade logic instance.
     * @param context String. Set to AngFactory if null
    ...
    private static String getContext(String context)
    {
        if (context == null)
        {
            context = "org.andromda.cartridges.angularjs.metafacades.AngFactory";
        }
        return context;
    }
     ...
     * @return String
     */
    protected abstract String handleGetUrl();
    ...
    {
        // getUrl has no pre constraints
        String returnValue = handleGetUrl();
        // getUrl has no post constraints
        return returnValue;
    }
    ...
    /**
     * 
     * @return handleIsCreate()
     */
    public boolean isCreate()
    {
        // isCreate has no pre constraints
        boolean returnValue = handleIsCreate();
        // isCreate has no post constraints
        return returnValue;
    }
    ...
    /**
     * 
     * @return handleIsUpdate()
     */
    public boolean isUpdate()
    {
        // isUpdate has no pre constraints
        boolean returnValue = handleIsUpdate();
        // isUpdate has no post constraints
        return returnValue;
    }
    ...
    /**
     * 
     * @return handleIsDelete()
     */
    public boolean isDelete()
    {
        // isDelete has no pre constraints
        boolean returnValue = handleIsDelete();
        // isDelete has no post constraints
        return returnValue;
    }
    ...
    /**
     * 
     * @return handleIsQuery()
     */
    public boolean isQuery()
    {
        // isQuery has no pre constraints
        boolean returnValue = handleIsQuery();
        // isQuery has no post constraints
        return returnValue;
    }
     ...
     * @return String
     */
    protected abstract String handleGetFname();

    /**
     * 
     * @return handleGetFname()
     */
    public String getFname()
    {
        // getFname has no pre constraints
        String returnValue = handleGetFname();
        // getFname has no post constraints
        return returnValue;
    }
     ...
     * @return boolean
     */
    protected abstract boolean handleIsShow();
    ...
    {
        // isShow has no pre constraints
        boolean returnValue = handleIsShow();
        // isShow has no post constraints
        return returnValue;
    }
     ...
     * @return String
     */
    protected abstract String handleGetShowParams();

    /**
     * 
     * @return handleGetShowParams()
     */
    public String getShowParams()
    {
        // getShowParams has no pre constraints
        String returnValue = handleGetShowParams();
        // getShowParams has no post constraints
        return returnValue;
    }
     ...
     * @return String
     */
    protected abstract String handleGetDeleteParams();

    /**
     * 
     * @return handleGetDeleteParams()
     */
    public String getDeleteParams()
    {
        // getDeleteParams has no pre constraints
        String returnValue = handleGetDeleteParams();
        // getDeleteParams has no post constraints
        return returnValue;
    }
     ...
     * @return String
     */
    protected abstract String handleGetShapedShowParams();

    /**
     * 
     * @return handleGetShapedShowParams()
     */
    public String getShapedShowParams()
    {
        // getShapedShowParams has no pre constraints
        String returnValue = handleGetShapedShowParams();
        // getShapedShowParams has no post constraints
        return returnValue;
    }
    ...
    public final AngController getAngController()
    {
        ...
        // angFactory has no pre constraints
        ...
        catch (ClassCastException ex)
        {
            ...
            AngFactoryLogic.logger.warn("incorrect metafacade cast for AngFactoryLogic.getAngController AngController " + result + ": " + shieldedResult);
        }
        // angFactory has no post constraints
